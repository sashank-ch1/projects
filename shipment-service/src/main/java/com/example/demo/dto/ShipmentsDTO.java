...
public ShipmentsDTO(String orderid,String carriername,String shippingAddress,String paymentstatus,String returnstatus) {
...
public String toString() {
	return "ShipmentsDTO [orderid=" + orderid + ", carriername=" + carriername + ", shippingAddress=" + shippingAddress
			+ ", paymentstatus=" + paymentstatus + ", returnstatus=" + returnstatus + "]";
}
